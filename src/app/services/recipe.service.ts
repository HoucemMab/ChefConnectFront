...
export class RecipeService {
  ...
  {
    return this.httpCLient.post<any>('http://localhost:8094/api/add-recipe',recipe);
  }
  ...
  uploadMedia(formData : FormData) : Observable<any>{
    ...
    return this.httpCLient.post('http://localhost:8094/api/upload',formData,httpOptions)
  }
